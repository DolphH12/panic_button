...
import 'package:panic_app/models/map_emergency_model.dart';
...
class Visualizer3Page extends StatefulWidget {
  const Visualizer3Page({super.key});

  @override
  State<Visualizer3Page> createState() => _MainScreenState();
}

class _MainScreenState extends State<Visualizer3Page> {
  ...
  Future fetchEvents() async {
    ...
    for (final event in events['data']) {
      _mapEvents.add(MapEvent(
          ...
          longitude: -75.608296,
          description: "",
          comment: 'evento fake wdñclweñ{kweecñlwec{mweec{lklnwwec{lkwneec{knnwec{wwkñkecn{klwnec{lkwnecc{lwkenc', 
          direction: '', 
          kind: 0, 
          phone: '', 
          icon: ''
